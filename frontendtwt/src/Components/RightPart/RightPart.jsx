...
const RightPart = () => {
    ...
    const handleChangeTheme = ()=>{
        console.log('Change to Dark/Light Mode')
    }
  ...
  return (
    <div className='py-5 sticky top'>
        <div className='relative flex items-center'>
            ...
            <input className='py-3 rounded-full text-gray-500 w-full border-2 pl-12'/>
        ...
        <section className='mt-7 space-y-5'>
            ...
            <div>
                ...
                <p className='font-bold'>Philipphines v/s Switzerland</p>
            </div>
